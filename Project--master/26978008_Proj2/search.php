                                            ...
                                            <div class="col-sm-10 col-sm-offset-1">
                                                ...
                                                ?>
                                                    ...
                                                    if (isset($_GET['search'])) {
                                                        ...
                                                        FROM metadata_management WHERE CONCAT(picture, title, author, plocation, device, album, privacy, galleryid, tag) 
                                                        LIKE '%$filtervalues%' ";
                                                        $query_run = mysqli_query($conn, $query);
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <form action="metadata.php" method="POST" enctype="multipart/form-data">
                                                                                            ...
                                                                                            <button type="submit" name="edit_metadata" class="btn btn-primary"><i class="ti-write"></i></button>
