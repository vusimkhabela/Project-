            ...
            <li class="dropdown" id="menu-messages">
                <a href="#" data-toggle="dropdown" class="dropdown-toggle">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="btn" title="" href="#">MyPersonalSpace!</a></li>
                    </ul>
            </li>
            <li>
                    ...
                    <div class="widget-box">
                        ...
                        <section class="picturesuploaded" id="picturesuploaded">
                            ...
                            <div class="photo-gallery">
                                ...
                                <a href="#"><button class="btn"> View more <i class="fas fa-download"></i> </button></a>
                                <a href="#"><button class="btn"> Upload <i class="fas fa-download"></i> </button></a>
                            </div>
                        </section>

                        <section class="Chats" id="chats">
                            <h3 class="widget-title"> MY <span>CHATS</span></h3>
                            <div class="row">
                                <div class="info">
