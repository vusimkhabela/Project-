...
if (logged_in()) {
	...
	// $stmt->execute();
    $picturedata = mysqli_query($conn, "SELECT * FROM metadata_management ORDER BY id DESC");
    // $mysql = "SELECT * FROM metadata_management ORDER BY id DESC";
    ...
    <div class="container">
        <div class="col-dm-7 col-sm-offset-1">
            ...
            <div class="pics-container">
                <div class="pics-top-container">
                    <h3>Photo Gallery</h3>
                    <label for="check1">All Photos</label>
                    <label for="check2">Mono and Solo</label>
                    <label for="check3">Family Time</label>
                    <label for="check4">Travels</label>
                </div>
                ...
                <div class="photo-gallery">
                    <?php
                    if(mysqli_num_rows($picturedata)>0){
                        while($fetch = mysqli_fetch_assoc($picturedata)){
                            ?>
                            <img src ="./uploads/timeline/<?php echo $fetch['picture']; ?>">;
                            <?php
                        }
                    }
                    else{
                        echo "Timeline Gallery Empty";
                    }
                    ?>
                </div>
            </div>
                                ...
                                <a title="" href="#"><strong
                                          ...
                                          <div class="new-update clearfix">
                                            ...
                                            <span class="update-alert">
                                              <a title="" href="#"
                                                ><strong>Maruti is a Responsive Admin theme</strong></a
                                              >
                                          ...
                                          <div class="new-update clearfix">
                                            ...
                                            <span class="update-done">
                                              <a title="" href="#"
                                                ><strong>Envato approved Maruti Admin template</strong></a
                                              >
                                          ...
                                          <div class="new-update clearfix">
                                            ...
                                            <span class="update-notice">
                                              <a title="" href="#"
                                                ><strong
                                                  >I am alwayse here if you have any question</strong
                                                ></a
                                              >
