...
//         _class("special")[0].classList.add("active");
//     } else {
//         _class("special")[0].classList.remove("active");
//     }

//     if (password.length > 7) {
//         _class("length")[0].classList.add("active");
//     } else {
//         _class("length")[0].classList.remove("active");
//     }
// });
